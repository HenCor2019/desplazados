    ...
    <main className='sm:flex sm:justify-center sm:items-center h-auto w-full'>
      <section className='grid w-full h-auto grid-cols-1 grid-rows-2 xl:grid-cols-2 xl:grid-rows-1'>
        <div className='relative w-full h-full grid grid-cols-1 grid-flow-row order-5 md:my-2 lg:m-0'>
          <div className='absolute top-1 sm:relative z-20 flex justify-center items-center xl:hidden px-8 w-full'>
            <img
              src={QueSoniamos}
        ...
        <div className='flex flex-col justify-start items-center order-5 mt-10'>
          <img
            src={QueSoniamos}
            className='hidden xl:block sm:w-6/12 md:w-5/12 lg:w-4/12 xl:w-6/12 xl-2:w-5/12'
            alt='¿Que soñamos?'
          />
