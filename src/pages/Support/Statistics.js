...
function Statistics() {
    return (
        <main className="p-8 md:p-10">
            <img src={ Title } className="w-60 md:w-64 block mb-12" alt="Número que son personas" />
            <StatisticsInfo 
                sectionClasses = "mb-12 md:mb-8 flex flex-col"
                imgSrc =  { Timeline1 } 
                imgAlt = "Datos generales sobre El Salvador"
                divClasses = "w-full bg-cover bg-no-repeat p-8 -mt-1.5 lg:self-end lg:w-6/12 lg:transform lg:-translate-y-10"
            ...
            <StatisticsInfo 
                ...
                divClasses = "w-full bg-cover bg-no-repeat p-8 -mt-2.5 z-10 lg:w-6/12 lg:transform lg:-translate-y-10 m-auto" 
            ...
            <StatisticsInfo 
                ...
                divClasses = "w-full h-auto bg-cover bg-no-repeat p-8 -mt-2 lg:w-6/12 lg:absolute top-14 right-0" 
            ...
            <StatisticsInfo 
                ...
                divClasses = "w-full bg-cover bg-no-repeat p-8 -mt-2 lg:w-6/12 lg:transform lg:-translate-y-10 m-auto" 
            ...
            <StatisticsInfo 
                ...
                divClasses = "w-full bg-cover bg-no-repeat p-8 -mt-2 lg:w-6/12 lg:absolute top-20 right-0"
