        ...
        <section className="mt-8 lg:grid lg:grid-cols-3 lg:grid-flow-col lg:gap-8">
                <div>
                    ...
                    <p className="font-acumin text-black-700 leading-5 text-justify">
                        ...
                        <br /><br />
                        -Una vez tenía un poco de arena en la calle, él iba pasando y me dijo que si me la entraba, yo le dije que sí. Cuando terminó yo le quería pagar pero él me dijo que no podía agarrarme dinero-, recuerda Blanca, una anciana vecina de la familia. Era un líder nato.
                    </p>
                </div>
                <div>
                    <p className="font-acumin text-black-700 leading-5 text-justify">
                        ...
                        <br /><br />
                        Los pandilleros, al ver el apoyo que estaban teniendo de parte de las autoridades, llegaron hasta la casa, tocaron la puerta y les dijeron que pararan la búsqueda. -Llegaron como 8 muchachos (pandilleros)-, recuerda Jackeline, -y nos dijeron que no querían ver llegar a la policía, que si seguían investigando se iban a desquitar con nosotros-. Así pasaron 2 semanas, entre búsquedas de amigos y familiares, hasta que la PNC dejó de apoyar pues tenía más casos que atender.
                        <br /><br />
                        Jackeline no cesó la búsqueda. Los pandilleros enviaban niños a su casa con mensajes sobre el supuesto paradero de su hijo. Ella lo buscaba donde le decían que podía estar: cañales, predios baldíos, quebradas, montañas, barrancos. Su esposo puso la denuncia en la FGR.
                        <br /><br />
