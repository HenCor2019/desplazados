const Section5 = () => {
    return (
        <section className="mt-4 md:mt-8 lg:grid lg:grid-cols-3 lg:grid-flow-col lg:gap-8 p-4 mb-4 md:mb-0">
            ...
            <div>
                <p className="font-acumin text-black-700 leading-5 xl-2:leading-6 text-justify">
                    Pocos días después de cumplir el primer año de la desaparición de Marco, la familia se prepara para emprender un viaje, que esperan sea sin retorno. A pesar de llevar todos los documentos, no es seguro que se les reconozca como refugiados.
                    <br></br><br/>
            ...
            <div>
                <p className="font-acumin text-black-700 leading-5 xl-2:leading-6 text-justify">
                    ...
                    <br /><br />
                    -A mi no me duele dejar nada, me voy tranquila y espero no tener que regresar jamás al que fue mi país-, sentenció, antes de caminar junto a su familia por la zona de pasajeros, del Aeropuerto Internacional Monseñor Romero.
                </p>
            </div>
        </section>
    )
