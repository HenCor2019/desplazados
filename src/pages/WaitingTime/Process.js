  ...
  return (
    <div className="flex justify-center items-center flex-rigid">
      <div className="flex flex-col justify-center items-center w-10/12 sm:w-7/12 pb-4">
        ...
        <ul className="grid-cols-5 w-full hidden">
          <Tab
            name="La familia de Andrés"
            color="#F76856"
            customizeStyle="rounded-tl-lg"
            src={Image5}
          ...
          />
          <Tab
            name="Soluciones duraderas"
            customizeStyle="rounded-tr-lg"
            color="#009BF9"
            src={Image1}
            onClick={onClickHandler}
          />
        ...
        <div
          style={{ backgroundColor: '#009BF9' }}
          className="w-full hidden rounded-b-lg"
        >
